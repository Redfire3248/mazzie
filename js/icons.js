...
const ICONS = {
  ...
  flipv:    '<path d="M12 3v18M7 7.5L12 3l5 4.5M7 16.5L12 21l5-4.5"/>',
  mirror:   '<path d="M12 3v18" stroke-dasharray="2 2.5"/><path d="M9 7L4 12l5 5M15 7l5 5-5 5"/>',
  ghost:    '<path d="M6 20V11a6 6 0 0 1 12 0v9l-2-1.6-2 1.6-2-1.6-2 1.6-2-1.6z"/><path d="M9.8 11h.01M14.2 11h.01"/>',
  spinner:  '<path d="M20 12a8 8 0 1 1-2.3-5.7"/><path d="M20 4v4h-4"/>',
